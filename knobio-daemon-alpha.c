/*
 *knobio-daemon-alpha.c
 * --------------
 *
 * This code to be used with the Rasberry Pi and the alpha version board (Blue Mayhew Labs board)
 * It changes the setup of ALSA mixer which seems to be specific to the Pi B
 *
 ...
 *
 * Compile with: 
 * sudo gcc -o knobio-daemon-alpha knobio-daemon-alpha.c arduino-serial-lib.c -lasound
 * 
 * Run with: 
 * sudo ./knobio-daemon-alpha
 *
